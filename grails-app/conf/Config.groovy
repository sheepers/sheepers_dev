...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'sheepers.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'sheepers.UserRole'
...
grails.plugins.springsecurity.securityConfigType = 'Requestmap'
grails.plugins.springsecurity.ui.register.postRegisterUrl = '/user/dash'
grails.plugins.springsecurity.successHandler.defaultTargetUrl = '/user/dash'
...
fileupload.directory = '/Users/Ofir/sheepers_dev/user-images'

mytry = '${userHome}/.grails/${appName}'