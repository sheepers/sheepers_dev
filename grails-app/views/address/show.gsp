	...
	<body>
		...
		<div id="show-address" class="content scaffold-show" role="main">
			...
			<ol class="property-list address">
				...
				<g:if test="${addressInstance?.floorNumber}">
				<li class="fieldcontain">
					<span id="floorNumber-label" class="property-label"><g:message code="address.floorNumber.label" default="Floor Number" /></span>
					
						<span class="property-value" aria-labelledby="floorNumber-label"><g:fieldValue bean="${addressInstance}" field="floorNumber"/></span>
				...
				<g:if test="${addressInstance?.street_number}">
				<li class="fieldcontain">
					<span id="street_number-label" class="property-label"><g:message code="address.street_number.label" default="Streetnumber" /></span>
					
						<span class="property-value" aria-labelledby="street_number-label"><g:fieldValue bean="${addressInstance}" field="street_number"/></span>
