			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="userPhoneNumber" title="${message(code: 'profile.userPhoneNumber.label', default: 'User Phone Number')}" />
				...
				<g:each in="${profileInstanceList}" status="i" var="profileInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${profileInstance.id}">${fieldValue(bean: profileInstance, field: "userPhoneNumber")}</g:link></td>
